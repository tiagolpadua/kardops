...
- Markdown quality tooling with `markdownlint-cli2`, Husky pre-commit hook, and auto-fix command (`npm run lint:md:fix`).
...
- `.gitkeep` files added to Kanban board folders (`0-backlog`, `1-todo`, `2-doing`, `3-blocked`, `4-done`, `5-archive`, `9-templates`) in all language packs (`en`, `pt-br`, `es`).
